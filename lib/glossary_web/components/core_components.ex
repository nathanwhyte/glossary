defmodule GlossaryWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: GlossaryWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GlossaryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GlossaryWeb.Gettext, "errors", msg, opts)
    end
  end
